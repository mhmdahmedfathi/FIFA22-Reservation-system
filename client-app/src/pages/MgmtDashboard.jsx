...
import { addStadium, add_editMatch, fetchMatchs, fetchTeams, fetchStadiums, fetchReferees } from './Helpers/Mgmt';
...
function MgmtDashboard() {
    ...
    } = useCurrentState((value) => team2 === value || Teams.find((team) => team.name === value) === undefined);
    const {
        value: team2,
        error: errorTeam2,
        handleChange: changeTeam2,
        handleEvent: handleTeam2,
    } = useCurrentState((value) => team1 === value || Teams.find((team) => team.name === value) === undefined);
    ...
    } = useCurrentState((value) => stadiums.find((stadium) => stadium.name === value) === undefined);
    ...
    } = useCurrentState((value) => LineMan1 === value || LineMan2 === value || referees.find((Referee) => Referee.name === value) === undefined);
    ...
    } = useCurrentState((value) => MainReferee === value || LineMan2 === value || referees.find((Referee) => Referee.name === value) === undefined);
    ...
    } = useCurrentState((value) => LineMan1 === value || MainReferee === value || referees.find((Referee) => Referee.name === value) === undefined);
    ...
    useEffect(() => {
        if (errorTeam1) {
            seterror("Make sure that Team 1 name is not the same as Team 2 name and that it is found in the teams list");
        } else if (errorTeam2) {
            seterror("Make sure that Team 2 name is not the same as Team 1 name and that it is found in the teams list");
        }
                                ...
                                <div className="col-12 col-md-6 form-group mb-3">
                                    ...
                                    <div style={{ "display": "flex" }} >
                                        ...
                                        <div className="dropdown" id="title" >
                                            ...
                                            <ul className="dropdown-menu" style={{ "borderBottomLeftRadius": "0px", "borderTopLeftRadius": "0px" }}>
                                                {Teams.length > 0 && Teams.map((team, index) => (
                                                    <li key={index} onClick={() => { changeTeam1(team.name) }}><a className="dropdown-item" href="#">{team.name}</a></li>
                                                ))}
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div className="col-12 col-md-6 form-group mb-3">
                                    ...
                                    <div style={{ "display": "flex" }} >
                                        ...
                                        <div className="dropdown" id="title" >
                                            ...
                                            <ul className="dropdown-menu" style={{ "borderBottomLeftRadius": "0px", "borderTopLeftRadius": "0px" }}>
                                                {Teams.length > 0 && Teams.map((team, index) => (
                                                    <li key={index} onClick={() => { changeTeam2(team.name) }}><a className="dropdown-item" href="#">{team.name}</a></li>
                                                ))}
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div className="col-12 col-md-6 form-group mb-3">
                                    ...
                                    <div style={{ "display": "flex" }} >
                                        ...
                                        <div className="dropdown" id="title" >
                                            ...
                                            <ul className="dropdown-menu" style={{ "borderBottomLeftRadius": "0px", "borderTopLeftRadius": "0px" }}>
                                                {stadiums.length > 0 && stadiums.map((stadium, index) => (
                                                    <li key={index} onClick={() => { changeMatchVenue(stadium.name) }}><a className="dropdown-item" href="#">{stadium.name}</a></li>
                                                ))}
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div className="col-12 col-md-6 form-group mb-3">
                                    ...
                                    <div style={{ "display": "flex" }} >
                                        ...
                                        <div className="dropdown" id="title" >
                                            ...
                                            <ul className="dropdown-menu" style={{ "borderBottomLeftRadius": "0px", "borderTopLeftRadius": "0px" }}>
                                                {referees.length > 0 && referees.map((referee, index) => (
                                                    <li key={index} onClick={() => { changeMainReferee(referee.name) }}><a className="dropdown-item" href="#">{referee.name}</a></li>
                                                ))}
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div className="col-12 col-md-6 form-group mb-3">
                                    ...
                                    <div style={{ "display": "flex" }} >
                                        ...
                                        <div className="dropdown" id="title" >
                                            ...
                                            <ul className="dropdown-menu" style={{ "borderBottomLeftRadius": "0px", "borderTopLeftRadius": "0px" }}>
                                                {referees.length > 0 && referees.map((referee, index) => (
                                                    <li key={index} onClick={() => { changeLineMan1(referee.name) }}><a className="dropdown-item" href="#">{referee.name}</a></li>
                                                ))}
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div className="col-12 col-md-6 form-group mb-3">
                                    ...
                                    <div style={{ "display": "flex" }} >
                                        ...
                                        <div className="dropdown" id="title" >
                                            ...
                                            <ul className="dropdown-menu" style={{ "borderBottomLeftRadius": "0px", "borderTopLeftRadius": "0px" }}>
                                                {referees.length > 0 && referees.map((referee, index) => (
                                                    <li key={index} onClick={() => { changeLineMan2(referee.name) }}><a className="dropdown-item" href="#">{referee.name}</a></li>
                                                ))}
                                            </ul>
                                        </div>
                                    </div>
